...
if __name__ == '__main__':
    ...
    parser.add_argument('--seed_id',
                        type=int,
                        default=1,
                        help='Seed for mapper RNGs and simulator start state.')
    ...
    with open(args.config) as f:
        ...
        config['dataset']['seed_id'] = args.seed_id
        if 'env' in config:
    ...
    dataset:Union[HabitatDataset] = get_dataset(config, user_config, args.scene_id, args.remark, args.seed_id)
